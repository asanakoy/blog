...
{% include img.html
            src="Kaggle-Lyft/Kaggle-Lyft-header.png"
            alt="Header image"
            class="center"
%}
...
{% include img.html
            src="Kaggle-Lyft/cars.png"
            alt="LYFT cars"
            caption='Fig: Lyft autonomous vehicle which was used to collect the data. Source: <a href="https://self-driving.lyft.com/level5/">link</a>.'
            style="width: 100%;"
            class="center"
%}
...
{% include img.html
            src="Kaggle-Lyft/av-screen1.jpg"
            alt="img"
            style="width: 80%; margin-bottom: 0px; border-width: 0 0 6px 0; border-style: solid;"
            class="center"
%}
{% include img.html
            src="Kaggle-Lyft/av-screen3.jpg"
            alt="img"
            caption='Fig: This is how Lyft collected the dataset: (Left) Images captured by cameras, (Right) Visualization of the Lyft\'s perception system. Source: <a href="https://self-driving.lyft.com/level5/">link</a>.'
            style="width: 80%;"
            class="center"
%}
...
{% include img.html
            src="Kaggle-Lyft/lyft-av-pipeline-with-red-box.png"
            alt="img"
            caption='Fig: Full pipeline of the autonomous vehicle decision-making system. From sensory input to path planning. The task of this competition (motion prediciton) is outlined in red. Source: <a href="https://self-driving.lyft.com/level5/">link</a>.'
            style="width: 100%;"
            class="center"
%}
...
{% include img.html
            src="Kaggle-Lyft/task.png"
            caption='Fig: Future motion prediction problem. The AV needs to know whether the oncoming vehicle will turn right or go straight.
            Source: <a href="https://www.reddit.com/r/SelfDrivingCars/comments/l1i31x/motion_prediction_winners_of_lyfts_motion">link</a>.'
...
{% include img.html
            ...
            src="Kaggle-Lyft/evaluation_metric2.png"
...
{% include img.html
            alt='img'
            src="Kaggle-Lyft/cnn_baseline.png"
            caption="Fig: Baseline CNN model."
...
{% include img.html
            alt='img'
            src="Kaggle-Lyft/cnn_backbones.png"
            caption="Fig: Our baseline CNN models with different backbones."
            style="width: 100%" class="center"
%}
...
{% include img.html
            alt='img'
            src="Kaggle-Lyft/cnn_baseline_16mod.png"
            caption="Fig: Our baseline CNN models with 16 hypotheses."
...
{% include img.html
            alt='img'
            src="Kaggle-Lyft/3mod_vs_16mod.png"
            caption="Fig: Comparison of the trajectories predicted by (Left) the model with 3 proposals vs (Right) the model with 16 proposals. The model with 16 outputs generates more diverse trajectories."
            style="width: 100%" class="center"
%}
...
{% include img.html
            alt='img'
            src="Kaggle-Lyft/ensembling1.png"
            caption="Fig: Our ensemble of 7 models generates 34 different trajectory hypotheses."
...
{% include img.html
            alt='img'
            src="Kaggle-Lyft/nms_boxes.png"
            caption='Fig: Non-maximum suppression for detections. <a href="https://pjreddie.com/darknet/yolov2/"> Source</a>.'
...
{% include img.html
            alt='k-means'
            src="Kaggle-Lyft/k_means.png"
            caption='Fig: Ensembling by clustering the hypotheses.'
...
{% include img.html
            alt='GMM'
            src="Kaggle-Lyft/gmm.png"
            caption='Fig: Ensembling by fitting a Gaussian Mixture Model to the hypotheses.'
            style="width: 100%" class="center"
%}
...
{% include img.html
            alt='Set Transformer for motion prediction'
            src="Kaggle-Lyft/with_transformer.png"
            caption="Fig: Ensembling by using a Set Transformer."
...
{% include img.html
            alt='Set Transformer for motion prediction'
            src="Kaggle-Lyft/set_transformer.png"
            caption="Fig: Architecture of our Set Transformer"
            style="width: 100%" class="center"
%}
...
{% include img.html
            alt='Set Transformer for motion prediction'
            src="Kaggle-Lyft/train_loss.png"
            caption="Fig: Training with Cosine Annealing learning rate scheduler. Every next learning rate cycle loss value significantly drops."
            style="width: 65%" class="center"
%}
...
{% include img.html
            alt='img'
            src="Kaggle-Lyft/sparse_history.png"
            caption="Fig: To increase the model training speed, we used only a sparse set of history snapshots when generated training images: 1, 2, 4, and 8 ticks in the past."
            style="width: 60%" class="center"
%}
...
{% include img.html
            alt='Table ablations'
            src="Kaggle-Lyft/table_ablations.png"
            style="width: 90%" class="center"
%}
...
{% include img.html
            alt='Results table 1'
            src="Kaggle-Lyft/table_final.png"
            style="width: 90%" class="center"
%}
